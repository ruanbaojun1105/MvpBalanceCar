 ...
 * 颜色选择板
 */
public class ColorBoardSim extends LinearLayout {

    public static final int widthSize=5;//色块横向数目
    public static final int heightSize=1;//色块纵向数目
    ...
    public ColorBoardSim(Context context) {
       this(context, null);
    }

    public ColorBoardSim(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ColorBoardSim(Context context, AttributeSet attrs, int defStyleAttr) {
