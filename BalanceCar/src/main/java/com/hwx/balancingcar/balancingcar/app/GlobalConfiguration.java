...
//                    okhttpBuilder.sslSocketFactory(); //支持 Https,详情请百度
                    ...
                    RetrofitUrlManager.getInstance().putDomain("server8082", Api.server8082);
                    RetrofitUrlManager.getInstance().putDomain("server8083", Api.server8083);
                    RetrofitUrlManager.getInstance().putDomain("server8084", Api.server8084);
