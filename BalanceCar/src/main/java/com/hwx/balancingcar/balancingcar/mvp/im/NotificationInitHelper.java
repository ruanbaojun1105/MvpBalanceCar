...
import com.hwx.balancingcar.balancingcar.AppConfig;
...
//        }
        return false;
//        if ( AppConfig.getInstance().getBoolean("check_notification", true))
//            return false;
//        else {
...
//            return false;
//        }
        return AppConfig.getInstance().getBoolean("check_checkboxShock", true);
    }
...
//            return false;
//        }
        return AppConfig.getInstance().getBoolean("check_checkboxVoice", true);
    }
...
//        int bound = (int) App.getContext().getResources().getDimension(
//                com.alibaba.sdk.android.R.dimen.aliwx_smily_column_width);
//        CharSequence charSequence= smilyCache.getSmilySpan(App.getContext(), message.getContent(), bound, false);
//        return charSequence.toString();
    ...
    public Intent getCustomNotificationIntent(YWConversation conversation, YWMessage message, int totalUnReadCount) {
        ...
        intent.setClass(App.getContext(), ChatConversationActivity.class);
    ...
    public int getNotificationIconResID() {
        return R.drawable.aerlang_head;
    }
    ...
    public String getTicker(YWConversation conversation, YWMessage message, int totalUnReadCount) {
        return "您有"+totalUnReadCount+"条新的消息！";
    }
}
